...
//[Route("api/cursos")]
//public class CursoController(ICursoRepository cursoRepository, ICursoService cursoService, INotificador notificador, IAspNetUser user) : MainController(notificador, user)
//{
//    [AllowAnonymous]
//    [HttpGet]
